...
Welcome to `pairprog` contributor's guide.
...
If you experience bugs or general issues with `pairprog`, please have a look
...
You can help improve `pairprog` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pairprog` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pairprog`'s files. While this mechanism can
...
```
conda create -n pairprog python=3 six virtualenv pytest pytest-cov
conda activate pairprog
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pairprog.git
   cd pairprog
   ```
...
5. Install [pre-commit]:
   ...
   `pairprog` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pairprog
[issue tracker]: https://github.com/<USERNAME>/pairprog/issues
